...
export default function ContactPage() {
  ...
  return (
    <main className="bg-[#fcfcfd] min-h-screen">
      ...
      <section className="pt-48 pb-32 px-4 lg:px-6">
        <div className="max-w-[75vw] mx-auto">
          
          {/* Banner Section (Service Card Style) */}
          <div className="soft-card p-6 lg:p-8 bg-white reveal mb-24">
          ...
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-20 lg:gap-40 items-start mb-32">
            {/* Left Content */}
